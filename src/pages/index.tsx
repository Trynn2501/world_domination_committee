      ...
      <div className="desktop-display">
        ...
        <section id="about">
          ...
          <div className="min-[481px]:grid min-[481px]:grid-cols-2 text-center min-[481px]:my-12 min-[481px]:mx-12 min-[481px]:px-12 min-[481px]:space-x-16">
            <div>
              <Image src="/images/wdc headshot trynn.jpg" alt="Photo of Trynn" layout="fixed" width="300px" height="300px" />
            ...
            <div>
              <Image src="/images/wdc headshot x.jpg" alt="Photo of Xenyth" layout="fixed" width="300px" height="300px" />
